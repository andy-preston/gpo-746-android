; For usartBaudRateRegister calculations, please see:
;     src/buildSrc/src/main/kotlin/gpo_746/AvrConstants.kt

.macro SetupSerial
    ldi _io, high(@usartBaudRateRegister@) ; Set Baud rate.
    out UBRRH, _io                         ; Always set high before low!
    ldi _io, low(@usartBaudRateRegister@)  ; Writing UBRRL triggers an immediate
